...
export function RegisterForm({ onSwitch }: RegisterFormProps) {
  ...
  const validate = () => {
    ...
    else if (values.password.length < 8) e.password = "Minimum 8 characters";
  ...
  return (
    <form onSubmit={handleSubmit} noValidate className="flex flex-col gap-5">
      <div className="flex flex-col gap-1.5">
        <Label htmlFor="reg-name" className="text-[11px] uppercase tracking-widest text-muted-foreground">
          Full Name
        </Label>
        <Input
          id="reg-name"
          ...
          className={cn("h-11 text-sm", errors.fullName && "border-destructive")}
        />
        {errors.fullName && <p className="text-[11px] text-destructive">{errors.fullName}</p>}
      </div>

      <div className="flex flex-col gap-1.5">
        <Label htmlFor="reg-email" className="text-[11px] uppercase tracking-widest text-muted-foreground">
          Email
        </Label>
        <Input
          id="reg-email"
      ...
      <div className="flex flex-col gap-1.5">
        <Label htmlFor="reg-password" className="text-[11px] uppercase tracking-widest text-muted-foreground">
          Password
        </Label>
      ...
      <div className="flex flex-col gap-1.5">
        <Label htmlFor="reg-confirm" className="text-[11px] uppercase tracking-widest text-muted-foreground">
          Confirm Password
        </Label>
        <Input
          id="reg-confirm"
          ...
          className={cn("h-11 text-sm", errors.confirmPassword && "border-destructive")}
        />
